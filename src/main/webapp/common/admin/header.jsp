	...
	<ul class="navbar-nav ml-auto">
		...
		<li class="nav-item dropdown no-arrow mx-1"><a
			...
			<div
				...
				</a> <a class="dropdown-item text-center small text-gray-500" href="#">Hiển
					thị tất cả thông báo</a>
			</div></li>
		...
		<li class="nav-item dropdown no-arrow"><a
			...
			aria-expanded="false"> <span
				class="mr-2 d-none d-lg-inline text-gray-600 small">${USERMODEL.hoTen}</span>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="logout?action=logout">Đăng xuất</a>
                </div>
            </div>
        </div>
    </div>
